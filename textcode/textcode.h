...
int             fmt_to_sa2(size_t (*func)(char *, const char *, size_t,
		const char *), stralloc * sa, const char *src, size_t len, const char *escapeme);
...
#ifdef ARRAY_H
void            fmt_to_array(size_t (*func)(char *, const char *, size_t), array *, const char *, size_t);
void            fmt_to_array2(size_t (*func)(char *, const char *,size_t, const char *), array *, const char *, size_t, const char *);
void            fmt_tofrom_array(size_t (*func)(char *, const char *, size_t), array * dest, array * src);
void            fmt_tofrom_array2(size_t (*func)(char *, const char *, size_t, const char *), array *, array *, const char *);
...
/*- can store 0-0x7fffffff */
size_t          fmt_utf8(char *, uint32_t);
/*- 0-0x7f: 1 byte, above that 1+bytes_needed bytes */
size_t          fmt_asn1derlength(char *, unsigned long long);
/*- 1 byte for each 7 bits; upper bit = more bytes coming */
size_t          fmt_asn1dertag(char *, unsigned long long);
